...
* TensorFlow 1.15.0
* NumPy 1.16.1
In this folder, there is an execution python code file with data.
The file "nisc_impute.py":
It will read sparse raw data "example_raw_data.npy", and conduct the imputation. The raw data has 1000 cells and 800 genes. The sparsity of the raw data is 70%.
